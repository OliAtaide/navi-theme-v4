  ...
  <?php if (is_search()): ?>
    ...
    <section class="events ">
      <div class="container py-navi-64">
        ...
        <?php if (search_result_has_occurency("events", $_GET['s'])): ?>
          <div class="row row-cols-lg-3 events-cards">
            <?php display_post_type_on_search("events", $_GET['s'], 6); ?>
          </div>
          <div class="w-100 d-flex justify-content-center">
            <button id="cM" class="text-center btn btn-navi-second shadow px-navi-32 py-2" data-page="2"
              data-url="<?php echo admin_url("admin-ajax.php") ?>" data-type="events" data-append=".events-cards"
  ...
  <?php elseif (is_archive()): ?>
    ...
    <section class="news archive-news">
      <div class="container">
              ...
              <?php foreach ($categories as $category): ?>
                <div>
                  ...
                  <label class="btn cat btn-outline-navi-second" for="<?= $category->cat_ID; ?>"
                    data-url="<?php echo admin_url("admin-ajax.php") ?>" data-type="events" data-posts="6"
        ...
        <?php if (post_type_has_occurency("events")): ?>
          <div class="row mb-3 h-50">
            <?php display_post_type_on_windows_reload("events", 6); ?>
          </div>
